...
public class Exam05_4 {
    ...
    public String m2(@RequestParam Member member) {
        ...
        return String.format("m2(): id=%s,email=%s,password=%s", member.getId(), member.getEmail(),
                member.getPassword());
    }
    ...
    public void initBinder(WebDataBinder binder) {
        ...
        binder.registerCustomEditor(java.sql.Date.class, /* 요청 핸들러의 파라미터 타입 */
        ...
        binder.registerCustomEditor(bitcamp.mvc.vo.Member.class, //요청 핸들러의 파라미터 타입 
                new PropertyEditorSupport() {
                    @Override
                    public void setAsText(String text) throws IllegalArgumentException {
